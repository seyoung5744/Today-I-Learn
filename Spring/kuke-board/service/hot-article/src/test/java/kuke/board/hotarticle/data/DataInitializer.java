...
public class DataInitializer {
    ...
    RestClient articleServiceClient = RestClient.create("http://localhost:8000");
    RestClient commentServiceClient = RestClient.create("http://localhost:8001");
    RestClient likeServiceClient = RestClient.create("http://localhost:8002");
    RestClient viewServiceClient = RestClient.create("http://localhost:8003");
    ...
    void like(Long articleId, long likeCount) {
        while (likeCount-- > 0) {
            likeServiceClient.post()
                    .uri("/v1/article-likes/articles/{articleId}/users/{userId}/pessimistic-lock", articleId, likeCount)
                    .retrieve();
