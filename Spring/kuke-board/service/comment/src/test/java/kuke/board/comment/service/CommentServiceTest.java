...
class CommentServiceTest {
    ...
    @Test
    @DisplayName("하위 댓글이 삭제되고, 부모 댓글이 삭제되지 않았으면, 하위 댓글만 삭제한다.")
    void deleteShouldDeletedChildOnlyIfNotDeletedParent() {
        // given
        Long articleId = 1L;
        Long commentId = 2L;
    ...
    @Test
    @DisplayName("하위 댓글이 삭제되고, 부모 댓글도 삭제됐으면, 재귀적으로 모두 삭제한다.")
