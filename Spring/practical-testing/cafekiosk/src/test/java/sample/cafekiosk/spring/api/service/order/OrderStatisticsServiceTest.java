...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        ...
        Order order5 = createPaymentCompletedOrder(LocalDateTime.of(2024, 3, 5, 23, 59, 59), products);
        Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2024, 3, 6, 0, 0), products);
