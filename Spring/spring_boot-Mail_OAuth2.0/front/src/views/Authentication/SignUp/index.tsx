...
export default function SignUp() {
    ...
    const emailCertificationReponse = (responseBody: ResponseBody<EmailCertificationResponseDto>) => {
    ...
    const onEmailButtonClickHandler = () => {
        ...
        emailCertificationRequest(requestBody).then(emailCertificationReponse);
    };
