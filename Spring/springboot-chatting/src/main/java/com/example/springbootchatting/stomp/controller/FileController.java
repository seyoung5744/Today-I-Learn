...
import com.example.springbootchatting.stomp.dto.FileUploadDto;
import com.example.springbootchatting.stomp.service.S3FileService;
...
public class FileController {
    ...
    @PostMapping("/upload")
    public FileUploadDto uploadFile(@RequestParam("file") MultipartFile file, @RequestParam String roomId) {
    ...
    public ResponseEntity<byte[]> download(@PathVariable String fileName, @RequestParam String fileDir) {
